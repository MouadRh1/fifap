  ...
  resources: {
    fr: {
      translation: {
        ...
        contact_description: "Nous vous répondrons dans les meilleurs délais",
        nom: "Nom",
        prenom: "Prénom",
        votre_nom: "Votre nom",
        ...
        email: "Email",
        telephone: "Téléphone",
        conditions_acceptation: "J'accepte les",
        conditions_generales: "conditions générales d'utilisation",
        conditions_required: "Veuillez accepter les conditions générales",
        form_protected:
    ...
    ar: {
      translation: {
        ...
        contact_description: "سوف نقوم بالرد عليك في أقرب وقت",
        nom: "الاسم العائلي",
        prenom: "الاسم الشخصي",
        votre_nom: "اسم العائلة",
        votre_prenom: "الاسم الشخصي",
        email: "البريد الإلكتروني",
        telephone: "رقم الهاتف",
        conditions_acceptation: "أوافق على",
        conditions_generales: "الشروط العامة للاستخدام",
        conditions_required: "يرجى الموافقة على الشروط العامة",
        form_protected: "معلوماتك محمية ولن يتم مشاركتها",
        envoyer: "إرسال الرسالة",
        envoi_en_cours: "جاري الإرسال...",
        message_envoye: "تم إرسال رسالتك بنجاح !",
        erreur_envoi: "حدث خطأ. يرجى المحاولة مرة أخرى.",
        chat_button: "اتصل بنا",
        chat_title: "اتصل بنا",
        chat_description:
