...
import "swiper/css";
import ProgramData2025_FR from "../../Data/DataProgram_FR.jsx";
import ProgramData2025_AR from "../../Data/DataProgram_AR.jsx";
  ...
  return (
    <section className="pt-20 bg-gary-300 text-white">
      <div className="max-w-screen-2xl mx-auto px-3">
        ...
        >
          {t("programme_du_festival")} 2025
        </motion.h2>
        {/* <p className="text-lg max-w-lg text-gray-900 text-start mt-4">
          {t("decouvrez_programme_2025")}
        </p> */}
        <div className="mt-4">
          <SeeMore path="program/2025" children={t("voir_tout_programme")} />
        </div>
          ...
          >
            {ProgramData.map((event) => (
              <SwiperSlide key={event.id}>
                ...
                >
                  <Link to={`/program/2025/${event.slug}`}>
                    <SafeImage
...
export default ProgramHome2025;